...
> **Seed:** `1446` (jangan diubah agar reproducible). 
> **Tanggal generate:** 2026-05-19
...
### Distribusi topik UAS (per mahasiswa)

- **1. Pemerataan kualitas pembelajaran PAI** - 14 mahasiswa
- **2. Sertifikasi guru PAI** - 14 mahasiswa
- **3. Investasi infrastruktur digital madrasah** - 12 mahasiswa

### Distribusi kelompok per topik

- **1. Pemerataan kualitas pembelajaran PAI** - K01, K04, K07, K10, K13 (5 kelompok)
- **2. Sertifikasi guru PAI** - K02, K05, K08, K11, K14 (5 kelompok)
- **3. Investasi infrastruktur digital madrasah** - K03, K06, K09, K12 (4 kelompok)
...
3. Bila ada perbaikan data peserta (NIM/nama), edit 
   ...
   `python peserta/buat_kelompok.py --seed 1446`.
